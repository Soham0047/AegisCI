...
class SimpleVocab:
    ...
    @classmethod
    def build(cls, token_lists: list[list[str]], min_freq: int = 2, max_vocab: int = 5000) -> "SimpleVocab":
...
def load_binary_model(checkpoint_path: Path, device: str = "cpu") -> tuple[BinaryClassifier, SimpleVocab]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/dl"), help="Output directory")
